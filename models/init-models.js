...
function initModels(sequelize) {
  ...
  Posts.belongsToMany(Users, { as: 'user_id_Users', through: Likes, foreignKey: "post_id", otherKey: "user_id" });
  Posts.belongsToMany(Users, { as: 'user_id_Users_User_saved_posts', through: User_saved_posts, foreignKey: "post_id", otherKey: "user_id" });
  Users.belongsToMany(Posts, { as: 'post_id_Posts', through: Likes, foreignKey: "user_id", otherKey: "post_id" });
  Users.belongsToMany(Posts, { as: 'post_id_Posts_User_saved_posts', through: User_saved_posts, foreignKey: "user_id", otherKey: "post_id" });
  Users.belongsToMany(Users, { as: 'following_id_Users', through: Followers, foreignKey: "follower_id", otherKey: "following_id" });
  Users.belongsToMany(Users, { as: 'follower_id_Users', through: Followers, foreignKey: "following_id", otherKey: "follower_id" });
  ...
  Posts.hasMany(User_saved_posts, { as: "User_saved_posts", foreignKey: "post_id"});
  ...
  Users.hasMany(User_saved_posts, { as: "User_saved_posts", foreignKey: "user_id"});
